...
DELAY = 20  # Delay between site queries
EMAIL_INTERVAL = 300  # Delay between alert emails
...
Health of {site} is experiencing a {status} status!
"""
...
def error_log(site, status):
    ...
    print ("\n({}) {} STATUS: {}".format(strftime("%a %b %d %Y %H:%M:%S"),site,colorize(status, "yellow"),))
